...
**Run the API in dev:** `npm run start:dev` from this folder. Do **not** use `npx run start:dev` (that is not npm scripts and will error with `Cannot find module '.../start:dev'`).
